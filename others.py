...
embryo_names = ["181210plc1p1", "181210plc1p2", "181210plc1p3"]
...
if CELLSPAN_FLAG:
    for embryo_name in embryo_names:
        ...
        with open("ResultCell/StatShape/{}_time_tree.txt".format(embryo_name), 'rb') as f:
...
if TP_CELLS_FLAGE:
    for embryo_name in embryo_names:
        ...
        folder_name = os.path.join("./ResultCell/BinaryMembPostseg", embryo_name + "LabelUnified")
...
if LOST_CELL:
    for embryo_name in embryo_names:
        seg_folder = os.path.join("./ResultCell/BinaryMembPostseg", embryo_name + "LabelUnified")
...
if COPY_FILE:
    ...
    for embryo_name in embryo_names:
        ...
        transpose_csv(os.path.join("./ResultCell/StatShape", embryo_name + "_Stat.csv"),
